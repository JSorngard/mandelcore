...
subroutine render_ssaa(re,im,maxiters,depth,samplingfactor,deltar,deltai,result,n,m)
...
!$OMP parallel do shared(result,re,im) private(total,esc,coloffset,rowoffset,samples)
do i = 1, n
    do j = 1, m
        total   = 0.d0
        samples = 0
